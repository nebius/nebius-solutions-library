...
export NEBIUS_REGION="${NEBIUS_REGION:-eu-west2}"
export NEBIUS_S3_ENDPOINT="${NEBIUS_S3_ENDPOINT:-storage.${NEBIUS_REGION}.nebius.cloud}"
export NEBIUS_S3_BUCKET_NAME='slurm-mlperf-training'

export NEBIUS_CR_ENDPOINT='cr.nebius.cloud'
